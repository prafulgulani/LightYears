...
namespace ly
{
	...
	void ChaosStage::StartStage()
	{
		...
		mDifficultTimerHandle = TimerManager::Get().SetTimer(GetWeakRef(), &ChaosStage::IncreaseDifficilty, mSpawnIntervalDecrementInterval, true);
	...
	void ChaosStage::IncreaseDifficilty()
	{
