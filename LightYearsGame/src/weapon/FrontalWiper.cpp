...
namespace ly
{
	FrontalWiper::FrontalWiper(Actor* ownerActor, float cooldownTime, const sf::Vector2f& localOffset, float width)
		...
		mShooter5{ownerActor, 0.1, {localOffset.x + width/1.5f, localOffset.y},  0.f, "SpaceShooterRedux/PNG/Lasers/laserGreen11.png"},
		mShooter6{ownerActor, 0.1, {localOffset.x - width/1.5f, localOffset.y},  0.f, "SpaceShooterRedux/PNG/Lasers/laserGreen11.png"}
	{
	}
